...
| W4 | Compliance gate refuses a Replace | (internal -- `FileReplacementBusinessService.ProcessFileReplacement`) | `ComplianceFailureRecorder` overrides disposition to NoReplace/ComplianceGateFailed | `Features/QualityTesting/Disposition/ComplianceFailureRecorder.Record` |
