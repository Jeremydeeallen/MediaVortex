...
C6. Backplane / NFS workers untouched by default. All bare-metal Linux workers (larry, wakko, dot) keep `LocalStagingEnabled=FALSE` post-migration. Job-claim and encode paths byte-identical to today.
