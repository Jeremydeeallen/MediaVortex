...
- [ ] Step 8: Doc consolidation -- delete duplicate parameter tables in AudioStrategy / audio-completion / remux.flow / transcode.flow / media-tabs-and-loudness / command-builder docs
