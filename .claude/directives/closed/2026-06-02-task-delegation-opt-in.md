...
|---|---|---|
| Opt-in policy + warning shape | `.claude/rules/ceo-mode.md` (extended in this directive's Files) | d7f993b |
| Operator-visible toggle instructions | `CLAUDE.md` (extended in this directive's Files) | d7f993b |
