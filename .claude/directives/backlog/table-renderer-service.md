...
**Set:** 2026-06-13
**Status:** Backlog -- queued behind failure-accounting
...
Backlog 2026-06-13 -- to activate: copy this file to `.claude/directive.md`, set Status to `Active -- phase: NEEDS_STANDARDS_REVIEW`.
