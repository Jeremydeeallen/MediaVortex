...
- [ ] SMOKE-GATE (in progress): I9 (Version=c00931cb source tree with PreEncode rewrite loaded) queued Avatar Fire and Ash MediaFileId=690945 QueueId=171328; watching for >20 min PreEncode survival
- [ ] DELIVERING: close report
...
|---|---|
| DD1-DD6 | `Features/AudioNormalization/audio-normalization.flow.md` -- ST2 stuck-detection contract note |
