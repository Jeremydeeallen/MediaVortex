---
description: "Use when writing database migrations, schema changes, SQL queries, or modifying repository/database service code. Covers backward compatibility, idempotent migrations, and LIKE escaping."
applyTo: "**"
---
# Data Integrity
