...
- [x] Create `Services/ShouldQualityTestService.py`
- [x] Implement `ShouldQualityTestService` class
- [x] Add `ShouldTestFile(FilePath: str) -> bool` method
- [x] Add simple folder-based logic (configurable)

### Phase 2: Integration
- [x] Modify `ProcessTranscodeQueueService.HandleTranscodingResult()` to call ShouldQualityTestService
- [x] Add quality test queue creation when `ShouldTestFile() == True`
- [x] Add `CreateQualityTestQueueEntry()` method to DatabaseManager
